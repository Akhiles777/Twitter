    ...
    return (
        <div className='mr-35'>
            <form className="flex bg-zinc-800 border border-zinc-700 text-white rounded-md shadow text-sm">
                ...
                <input type="search" onChange={(e) => onChange(e.target.value)} value={value} spellCheck="false" name="text"
                ...
                <button className="w-10 grid place-content-center" aria-label="Clear input button" type="reset">
                    <svg strokeLinejoin="round" strokeLinecap="round" strokeWidth={2} stroke="currentColor" fill="none"
